...
func NewGDIRCastObject(typ runtime.GDTypable, expr GDIRNode, node ast.Node) (*GDIRCastObject, *GDIRObject) {
	return &GDIRCastObject{typ, expr, GDIRBaseNode{node}}, NewGDIRRegObject(cpu.RPop, node)
}
